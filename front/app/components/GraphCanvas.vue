  ...
  themeNodesSelection.each(function(d: any) {
    ...
    if (bookCount > 0) {
      ...
      iconG.append('path')
        ...
        .attr('fill', 'none')
        .attr('stroke', isLightMode.value ? 'rgba(71, 85, 105, 0.85)' : 'rgba(255, 255, 255, 0.85)')
      ...
      iconG.append('text')
        ...
        .attr('fill', isLightMode.value ? '#475569' : 'rgba(255, 255, 255, 0.92)')
        .text(bookCount)
    } else {
      ...
      iconG.append('path')
        ...
        .attr('fill', 'none')
        .attr('stroke', isLightMode.value ? 'rgba(71, 85, 105, 0.7)' : 'rgba(255, 255, 255, 0.55)')
        .attr('stroke-width', '1.5')
        .attr('stroke-linecap', 'round')
        .attr('stroke-linejoin', 'round')
