...
const initGraph = () => {
  ...
  rootIconGroup.append('path')
    ...
    .attr('fill', 'none')
    .attr('stroke', isLightMode.value ? '#9A3412' : '#FFFFFF')
  ...
  themeNodesSelection.each(function(d: any) {
    ...
    if (bookCount > 0) {
      ...
      iconG.append('path')
        ...
        .attr('fill', 'none')
        .attr('stroke', isLightMode.value ? 'rgba(15, 23, 42, 0.75)' : 'rgba(255, 255, 255, 0.85)')
      ...
      iconG.append('text')
        ...
        .attr('fill', isLightMode.value ? '#0F172A' : 'rgba(255, 255, 255, 0.92)')
        .text(bookCount)
    } else {
      ...
      iconG.append('path')
        ...
        .attr('fill', 'none')
        .attr('stroke', isLightMode.value ? 'rgba(15, 23, 42, 0.65)' : 'rgba(255, 255, 255, 0.55)')
        .attr('stroke-width', '1.5')
        .attr('stroke-linecap', 'round')
        .attr('stroke-linejoin', 'round')
