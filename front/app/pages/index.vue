<template>
  <div class="flex flex-col gap-8 sm:gap-10 pb-20 animate-in fade-in duration-500">
    <!-- Top Bar da Home (Visível EXCLUSIVAMENTE em Desktop: Busca Cmd+K e Ofensiva) -->
    <div class="hidden md:flex items-center justify-between gap-4">
      <!-- Barra de Busca Cmd+K Integrada (Desktop) -->
      <div
    ...
    <section class="flex flex-row items-center sm:items-start gap-4 sm:gap-8">
      ...
      <div class="flex flex-col justify-between gap-2.5 sm:gap-3 flex-1 min-w-0">
        <div class="flex flex-col gap-1">
          <!-- Título do Livro + Ofensiva no Mobile (Lado a Lado) -->
          <div class="flex items-start justify-between gap-2">
            ...
            <!-- Ofensiva no Mobile: renderizada ao lado do livro para enxugar espaço -->
