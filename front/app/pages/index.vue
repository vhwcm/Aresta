<template>
  <div class="flex flex-col gap-8 pb-20 animate-in fade-in duration-500">
    ...
    <!-- BLOCO 2: FLASHCARDS DO DIA (Posicionado ACIMA das anotações) -->
    ...
    <!-- BLOCO 3: ANOTAÇÕES (3 anotações com cabeçalho 'Anotações') -->
    <section class="flex flex-col gap-4">
      <div class="flex items-center justify-between">
        <div class="font-technical text-[10px] uppercase font-semibold tracking-widest text-textSecondary flex items-center gap-2">
...
// 3 Anotações mockadas do último livro lido
const activeBookNotes = computed(() => {
  return [
    ...
    },
    {
      ...
      page: 14,
      date: 'Há 3 dias',
      quote: 'D. Evarista reuniu em si todas as qualidades que um homem prudente poderia desejar.',
      insight: 'A visão utilitarista até mesmo nos relacionamentos afetivos do protagonista.'
    }
  ]
})
