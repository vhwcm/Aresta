<template>
  <div>
    ...
    <div v-if="auth.isLoggedIn.value" data-testid="auth-home" class="flex flex-col gap-8 sm:gap-10 pb-20 animate-in fade-in duration-500">
      ...
      <!-- BLOCO 1: ÚLTIMA LEITURA ATIVA (Clean, sem caixa, capa clicável, conversor em ícone e ofensiva ao lado no mobile) -->
      ...
      <!-- BLOCO 2: ÚLTIMA ANOTAÇÃO DO LIVRO (Clean, sem caixas, apenas 1 anotação) -->
      <section class="flex flex-col gap-4">
        <div class="flex items-center justify-between">
          <div class="font-technical text-[10px] uppercase font-semibold tracking-widest text-textSecondary flex items-center gap-2">
            ...
            Anotação & Destaque de {{ activeBookShortTitle }}
          </div>
      ...
      <!-- BLOCO 3: FLASHCARDS & REVISÃO DO DIA (Com link para Curva do Esquecimento) -->
      <section class="flex flex-col gap-4">
        <div class="flex items-center justify-between">
          <div class="font-technical text-[10px] uppercase font-semibold tracking-widest text-textSecondary flex items-center gap-2">
            <BrainIcon class="w-3.5 h-3.5 text-accent" />
            Revisão de Conhecimento · Flashcards
          </div>
    ...
    <div v-else data-testid="guest-landing" class="flex flex-col gap-16 py-8 md:py-12 animate-in fade-in duration-500">
      ...
      <section class="p-6 sm:p-10 rounded-3xl bg-gradient-to-br from-[#16171a] via-[#121315] to-[#0A0A0B] border border-accent/30 shadow-2xl flex flex-col gap-8">
        <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          ...
          <NuxtLink
            ...
            class="px-4 py-2.5 rounded-2xl bg-white/5 hover:bg-white/10 border border-divider hover:border-accent/40 text-textPrimary font-interface text-xs transition-all flex items-center gap-2 shrink-0 group"
          >
        ...
        <!-- Gráfico Nativo D3.js da Curva de Esquecimento -->
        <div class="bg-black/50 p-4 sm:p-6 rounded-2xl border border-divider">
          <div class="flex items-center justify-between mb-3 text-xs">
            <span class="font-technical text-[11px] text-accent uppercase font-semibold">Demonstração Interativa D3.js</span>
            <NuxtLink to="/curva-do-esquecimento" class="font-technical text-[10px] text-textSecondary hover:text-accent flex items-center gap-1">
