...
describe('Index Page (Landing Page & Home)', () => {
  ...
  it('renders guest landing page with Ebbinghaus forgetting curve highlight and login/register tabs', async () => {
  ...
  it('renders active reader home dashboard with Ebbinghaus info link when logged in', () => {
    vi.spyOn(authComposable, 'useAuth').mockReturnValue({
