<template>
  ...
  >
    ...
    <div class="flex-1 p-3 overflow-y-auto text-xs text-textSecondary select-none">
      ...
      <div v-else-if="displayContent" class="prose dark:prose-invert prose-xs max-w-none">
