<template>
  ...
  >
    <defs>
      ...
      >
        <path d="M 0 1.5 L 8 5 L 0 8.5 z" fill="var(--canvas-edge-default, #71717A)" />
      </marker>
    ...
    <g v-for="edge in computedEdges" :key="edge.id">
      ...
      >
        <rect
          ...
          height="22"
          rx="11"
          fill="var(--canvas-edge-label-bg, #18181BEE)"
          :stroke="edge.isSelected ? '#E57B55' : 'var(--canvas-shape-stroke, #3F3F46)'"
          stroke-width="1"
        />
        <text
          y="4"
          text-anchor="middle"
          fill="var(--canvas-edge-label-text, #D4D4D8)"
          font-size="11"
