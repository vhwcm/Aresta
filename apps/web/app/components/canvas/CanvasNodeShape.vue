...
const strokeColor = computed(() => {
  ...
  if (themeMode.value === 'light') return '#D4D4D8';
  if (themeMode.value === 'sepia') return '#D4C7B0';
  return '#3F3F46';
});
...
const fillColor = computed(() => {
  ...
  if (themeMode.value === 'light') return 'rgba(255, 255, 255, 0.95)';
  if (themeMode.value === 'sepia') return 'rgba(239, 230, 209, 0.95)';
  return '#18181BEE';
});
