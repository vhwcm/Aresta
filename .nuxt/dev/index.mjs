...
import { createFetch, Headers as Headers$1 } from 'file:///home/exati/projetos/Aresta/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/exati/projetos/Aresta/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, defineDriver, prefixStorage } from 'file:///home/exati/projetos/Aresta/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/exati/projetos/Aresta/node_modules/unstorage/drivers/fs.mjs';
import { mkdir, writeFile, rename, unlink, readFile } from 'node:fs/promises';
import fsDriver from 'file:///home/exati/projetos/Aresta/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///home/exati/projetos/Aresta/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest, hash as hash$1 } from 'file:///home/exati/projetos/Aresta/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/exati/projetos/Aresta/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/exati/projetos/Aresta/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/exati/projetos/Aresta/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/exati/projetos/Aresta/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/exati/projetos/Aresta/node_modules/radix3/dist/index.mjs';
import consola, { consola as consola$1 } from 'file:///home/exati/projetos/Aresta/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/exati/projetos/Aresta/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/exati/projetos/Aresta/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/exati/projetos/Aresta/node_modules/source-map/source-map.js';
import { defineDiagnostics, createConsoleReporter } from 'file:///home/exati/projetos/Aresta/node_modules/nostics/dist/index.mjs';
import { ansiFormatter } from 'file:///home/exati/projetos/Aresta/node_modules/nostics/dist/formatters/ansi.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/exati/projetos/Aresta/node_modules/devalue/index.js';
import { getContext as getContext$1 } from 'file:///home/exati/projetos/Aresta/node_modules/@nuxt/nitro-server/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/exati/projetos/Aresta/node_modules/errx/dist/index.js';
import { isVNode, isRef, toValue } from 'file:///home/exati/projetos/Aresta/node_modules/vue/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///home/exati/projetos/Aresta/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///home/exati/projetos/Aresta/node_modules/pathe/dist/index.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///home/exati/projetos/Aresta/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { renderToString } from 'file:///home/exati/projetos/Aresta/node_modules/vue/server-renderer/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/exati/projetos/Aresta/node_modules/unhead/dist/server.mjs';
import { walkResolver } from 'file:///home/exati/projetos/Aresta/node_modules/unhead/dist/utils.mjs';
import { DeprecationsPlugin } from 'file:///home/exati/projetos/Aresta/node_modules/unhead/dist/legacy.mjs';
import { PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///home/exati/projetos/Aresta/node_modules/unhead/dist/plugins.mjs';

const serverAssets = [{"baseName":"server","dir":"/home/exati/projetos/Aresta/server/assets"}];
...
function normalizeFsKey(item) {
	return `${item.replace(/[^\w.-]/g, "_").slice(0, 20)}-${crypto$1.createHash("sha256").update(item).digest("hex")}`;
}
/**
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/exati/projetos/Aresta","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/exati/projetos/Aresta/server","watchOptions":{"ignored":[null]}}));
storage.mount('cache:nuxt:payload', cache_driver_default({"driver":"/home/exati/projetos/Aresta/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.mjs","base":"/home/exati/projetos/Aresta/.nuxt/cache/nuxt/payload"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/exati/projetos/Aresta/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/exati/projetos/Aresta/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/exati/projetos/Aresta/.data/kv"}));
...
const _mdm9xKspFHKdRmfoLwjV8RKjDdEZZKQOuM4g7Xw7LOk = (function(nitro) {
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Leitor online de PDF e EPUB com efeito de virada de página realista."}],"link":[],"style":[],"script":[],"noscript":[],"title":"Aresta — Leitor de PDF e EPUB"};
...
const rootDir = "/home/exati/projetos/Aresta";
...
const plugins = [
  _mdm9xKspFHKdRmfoLwjV8RKjDdEZZKQOuM4g7Xw7LOk,
...
const _RMXFss = eventHandler((event) => {
