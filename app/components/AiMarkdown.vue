...
const enhanceCodeBlocks = () => {
  ...
  pres.forEach((pre) => {
    ...
    copyBtn.className = 'flex items-center gap-1.5 px-2.5 py-1 rounded bg-white/5 border border-divider hover:bg-white/10 text-textSecondary hover:text-white transition-colors text-[11px] cursor-pointer'
    copyBtn.innerHTML = `
